...
LatestRatesDto _$LatestRatesDtoFromJson(Map<String, dynamic> json) => LatestRatesDto(
...
Map<String, dynamic> _$LatestRatesDtoToJson(LatestRatesDto instance) => <String, dynamic>{
